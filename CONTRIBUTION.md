...
You can file a ticket for the bug/issue you found through [Issues](https://github.com/acronis/ui-components-library/issues) under project **UI component library**.
A clear reproduce steps will be very helpful to identify the root cause.
For the complicated scenario, you can also create an example in the [Sandbox](https://github.com/acronis/ui-components-library/sandbox/index.vue), or provide the example code in the ticket.
...
1. Fork [This repo](https://github.com/acronis/ui-components-library)
