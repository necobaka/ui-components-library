<script setup lang="ts">
  import type { AlertEvents, AlertProps } from './alert.ts';
  import './alert.css';
  ...
  >
    <div class="content">
      ...
      <div
        ...
        class="title"
      >
        <!-- @slot title - content of the Alert title -->
        <slot name="title">
          {{ title }}
        </slot>
      </div>
      ...
      <div
        ...
        class="actions"
      >
        <!-- @slot actions - Content for the actions -->
        <slot name="actions" />
      </div>
      <div
        v-if="$slots.right"
        class="right"
      >
        <!-- @slot right - Content for the right side actions -->
        <slot name="right" />
      </div>
    </div>
    <div
