<script setup lang="ts">
  ...
  document.title = 'theme dev | UI components library';
    ...
    <template #right>
      ...
      >
        ...
        >
          <Breadcrumb
            :border="n === 2"
            style="max-width: 720px; margin-bottom: 10px"
          >
          ...
          >
            <template #default="{ active }">
              <div
                ...
                :style="{ transform: `scaleY(${active ? 1 : 0.83})` }"
              >
                Content {{ n }}
              </div>
            </template>
...
body {
  ...
  margin: 0;
  overflow: hidden;
  color: var(--acv-content-color-base);
